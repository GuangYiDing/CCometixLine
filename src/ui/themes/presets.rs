    ...
    pub fn get_cometix() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_cometix::subscription_quota_segment(),
            ],
    ...
    pub fn get_default() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_default::subscription_quota_segment(),
            ],
    ...
    pub fn get_minimal() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_minimal::subscription_quota_segment(),
            ],
    ...
    pub fn get_gruvbox() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_gruvbox::subscription_quota_segment(),
            ],
    ...
    pub fn get_nord() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_nord::subscription_quota_segment(),
            ],
    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::subscription_quota_segment(),
            ],
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::subscription_quota_segment(),
            ],
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::subscription_quota_segment(),
            ],
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::subscription_quota_segment(),
            ],
